...
determined. The conversion from the supply voltage to the magnetic flux density
$B_0$ is given by the calibration recorded in the supplementary video and will be
inserted here.\footnote{TODO: Spannungs-zu-Magnetfeld-Umrechnung aus dem Video
ergänzen (lineare Kalibrierung $B_0(U)$), anschließend die $x$-Achsen der
Dispersionskurven in Tesla skalieren.}
...
sweep. The image is rotated and the dispersion curve is digitised (e.g.\ with
\texttt{engauge} or \texttt{WebPlotDigitizer}), yielding a \texttt{.csv} table of
the output frequency $\nu$ versus the external magnetic field $B_0$. The
resonance field $B_0$ is read off at the inflection / zero crossing of the
dispersion curve and used in Equation~\eqref{eq:gfactor} to determine the
$g$-factor.

% ==================================================================
\section{Measurements and Analysis}
% ==================================================================
\textit{Hinweis: Dieser Abschnitt enthält bereits die aufgenommenen
Messbilder. Die quantitative Auswertung (Resonanzfelder, $g$-Faktoren) wird
ergänzt, sobald die Spannungs-zu-Magnetfeld-Umrechnung aus dem Video vorliegt
(siehe Abschnitt~\ref{sec:sweep}).}
